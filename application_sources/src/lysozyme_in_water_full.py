...
@mpi(runner="mpirun", binary="gmx_mpi", processes="8")
@task(em=FILE_IN,
      em_energy=FILE_OUT)
...
@binary(binary='gracebat')  # usually grace or xmgrace, but gracebat in MN4
@task(xvg=FILE_IN,
      png=FILE_OUT)
def convert_xvg_to_png(conversion_flag='-nxy',
                       ...
                       png=None):
    # Command: gracebat -nxy protein_potential.xvg -hdevice PNG -hardcopy -printfile protein_potential.png
    pass
